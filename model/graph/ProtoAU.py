...
class ProtoAU(GraphRecommender):
    def __init__(self, conf, training_set, test_set):
        ...
        args = OptionConf(self.config['ProtoAU'])
        # init backbone
    ...
    def proto_loss(self, z, prototypes, temperature=0.1):
        ...
        loss_au = self.align_loss(c_s, c_t) + self.uniform_loss(c_s , c_t) # here we choose lambda_3=1
    ...
    def train(self):
        ...
        for epoch in range(self.maxEpoch):
            for index, batch in enumerate(next_batch_pairwise(self.data, self.batch_size)):
                ...
                l2_loss = l2_reg_loss(self.reg, user_emb, pos_item_emb)
                ...
                cl_loss = self.cal_cl_loss([user_idx, pos_idx],[rec_user_emb, cl_user_emb], [rec_item_emb, cl_item_emb], [user_prototypes, item_prototypes], self.tau)
